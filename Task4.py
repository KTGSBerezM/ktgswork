...
#Задача #: Первый и последний участник
list_players = ["Маша", "Петя", "Саша", "Оля", "Кирилл"]
last_player = list_players[-1]
reestr = {"Первый участник": list_players[0]}
print("Последний участник:", last_player)
...
print("Последний лыжник:", last_participants)
...
last_books = sps_books[-1]
name = {"Пушкин": sps_books[0]}
print("Последняя книга:", last_books)
print("Пушкин:", name["Пушкин"])
...
print('Количетсво уникальных товаров:', len(unique_items))